 ...
 * template name: SOLAROX - Solar & Renewable Energy HTML Template
 * version: 1.0
 * description: SOLAR ENERGY Company HTML5 Template
 * author: uiaxis
...
$(window).on("load", function ()  {
  ...
  // left sidebar open
  $(".show-offcanvas,.left-sidebar-close,.left-sidebar-overlay").on("click",
    function () {
...
$(".expert-card").each(function () {
  ...
  $socialBtn.on("mouseover", function () {
    ...
    $socialBtn.find("i").removeClass("ti-plus").addClass("ti-minus");
  });
  ...
  $links.on("mouseout", function () {
    ...
    $socialBtn.find("i").addClass("ti-plus").removeClass("ti-minus");
  });
...
$(window).on("load", function () {
  setTimeout(() => {
    $(".loader-container").fadeOut("slow", function () {
      document.documentElement.style.overflow = "auto"; // Restore scrolling after fade-out completes
    });
  }, 400);
});
...
$(window).on("load", function () {
  ...
  function highlightStars(value) {
    $(".rating i").each(function () {
      ...
      $(this).toggleClass("ti-star-filled", starValue <= value);
    });
  }
});
